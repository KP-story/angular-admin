...
public class GenClass {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Reflections reflections = new Reflections("com.telsoft.core.spring.admin.entities");
            ...
            for (Method method : bd.getMethods()) {
                ...
                if (method.getParameterCount() == 0//
                    ...
                    if (methodName.length() <= 3)
                        continue;
                    String fieldName = lowerCaseFirstLetter(methodName.substring(3));
                    Param param = new Param();
                    param.name = fieldName;
                    param.type = method.getReturnType();
                    params.add(param);

                }

            }
            myEntities.add(new MyEntity(clasName, clasPath, pk, params));

        }


        String basePath = "com/kp/core/spring/admin";
...
//                test.createRepository(myEntities, repo_path);
    ...
    public static class MyEntity {
        ...
        public MyEntity(String className, String fullName, String pk, List<Param> params) {
